...
def test_validator_instantiation():
    ...
    with (
        patch("neurons.validator.validator.Thread") as threading_mock,
        ...
        with (
            patch(
                "neurons.validator.validator.Validator.setup_logging"
            ) as logging_mock,
            patch(
                "neurons.validator.validator.Validator.setup_bittensor_objects",
                new=_setup_bt_objects,
            ) as bt_objects_mock,
        ):
